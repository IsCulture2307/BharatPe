...
.method public constructor <init>(Lcom/bumptech/glide/load/engine/cache/MemoryCache;Lcom/bumptech/glide/load/engine/cache/DiskCache$Factory;Lcom/bumptech/glide/load/engine/executor/GlideExecutor;Lcom/bumptech/glide/load/engine/executor/GlideExecutor;Lcom/bumptech/glide/load/engine/executor/GlideExecutor;Lcom/bumptech/glide/load/engine/executor/GlideExecutor;)V
    ...
    :try_start_1
    iput-object p0, p2, Lcom/bumptech/glide/load/engine/ActiveResources;->e:Lcom/bumptech/glide/load/engine/EngineResource$ResourceListener;
...
.method public static g(Lcom/bumptech/glide/load/engine/Resource;)V
    .locals 1
...
.method public final f(Lcom/bumptech/glide/load/engine/EngineKey;ZJ)Lcom/bumptech/glide/load/engine/EngineResource;
    ...
    :try_start_0
    iget-object p4, p2, Lcom/bumptech/glide/load/engine/ActiveResources;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {p2, p4}, Lcom/bumptech/glide/load/engine/ActiveResources;->b(Lcom/bumptech/glide/load/engine/ActiveResources$ResourceWeakReference;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    sget p2, Lcom/bumptech/glide/util/LogTime;->a:I
    ...
    :cond_6
    instance-of p2, v1, Lcom/bumptech/glide/load/engine/EngineResource;
    ...
    invoke-virtual {v1}, Lcom/bumptech/glide/load/engine/EngineResource;->b()V

    iget-object p2, p0, Lcom/bumptech/glide/load/engine/Engine;->g:Lcom/bumptech/glide/load/engine/ActiveResources;

    invoke-virtual {p2, p1, v1}, Lcom/bumptech/glide/load/engine/ActiveResources;->a(Lcom/bumptech/glide/load/Key;Lcom/bumptech/glide/load/engine/EngineResource;)V
...
.method public final h(Lcom/bumptech/glide/GlideContext;Ljava/lang/Object;Lcom/bumptech/glide/load/Key;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/engine/DiskCacheStrategy;Lcom/bumptech/glide/util/CachedHashCodeArrayMap;ZZLcom/bumptech/glide/load/Options;ZZZZLcom/bumptech/glide/request/ResourceCallback;Ljava/util/concurrent/Executor;Lcom/bumptech/glide/load/engine/EngineKey;J)Lcom/bumptech/glide/load/engine/Engine$LoadStatus;
    ...
    iget-object v13, v1, Lcom/bumptech/glide/load/engine/Engine;->a:Lcom/bumptech/glide/load/engine/Jobs;

    if-eqz v9, :cond_0

    iget-object v13, v13, Lcom/bumptech/glide/load/engine/Jobs;->b:Ljava/util/HashMap;

    goto :goto_0

    :cond_0
    iget-object v13, v13, Lcom/bumptech/glide/load/engine/Jobs;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {v13, v10, v11}, Lcom/bumptech/glide/load/engine/EngineJob;->e(Lcom/bumptech/glide/request/ResourceCallback;Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {v0, v1, v10, v13}, Lcom/bumptech/glide/load/engine/Engine$LoadStatus;-><init>(Lcom/bumptech/glide/load/engine/Engine;Lcom/bumptech/glide/request/ResourceCallback;Lcom/bumptech/glide/load/engine/EngineJob;)V

    return-object v0

    :cond_2
    iget-object v13, v1, Lcom/bumptech/glide/load/engine/Engine;->d:Lcom/bumptech/glide/load/engine/Engine$EngineJobFactory;

    iget-object v13, v13, Lcom/bumptech/glide/load/engine/Engine$EngineJobFactory;->g:Landroidx/core/util/Pools$Pool;
    ...
    invoke-static {v13}, Lcom/bumptech/glide/util/Preconditions;->b(Ljava/lang/Object;)V

    monitor-enter v13

    :try_start_0
    iput-object v12, v13, Lcom/bumptech/glide/load/engine/EngineJob;->l:Lcom/bumptech/glide/load/Key;

    move/from16 v14, p14

    iput-boolean v14, v13, Lcom/bumptech/glide/load/engine/EngineJob;->m:Z

    move/from16 v14, p15

    iput-boolean v14, v13, Lcom/bumptech/glide/load/engine/EngineJob;->n:Z

    move/from16 v14, p16

    iput-boolean v14, v13, Lcom/bumptech/glide/load/engine/EngineJob;->o:Z

    iput-boolean v9, v13, Lcom/bumptech/glide/load/engine/EngineJob;->p:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    monitor-exit v13

    iget-object v14, v1, Lcom/bumptech/glide/load/engine/Engine;->f:Lcom/bumptech/glide/load/engine/Engine$DecodeJobFactory;

    iget-object v15, v14, Lcom/bumptech/glide/load/engine/Engine$DecodeJobFactory;->b:Landroidx/core/util/Pools$Pool;
    ...
    iget v10, v14, Lcom/bumptech/glide/load/engine/Engine$DecodeJobFactory;->c:I

    add-int/lit8 v11, v10, 0x1

    iput v11, v14, Lcom/bumptech/glide/load/engine/Engine$DecodeJobFactory;->c:I

    iget-object v11, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->a:Lcom/bumptech/glide/load/engine/DecodeHelper;
    ...
    iput-object v14, v11, Lcom/bumptech/glide/load/engine/DecodeHelper;->g:Ljava/lang/Class;

    iget-object v14, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->d:Lcom/bumptech/glide/load/engine/DecodeJob$DiskCacheProvider;

    iput-object v14, v11, Lcom/bumptech/glide/load/engine/DecodeHelper;->h:Lcom/bumptech/glide/load/engine/DecodeJob$DiskCacheProvider;

    move-object/from16 v14, p7

    iput-object v14, v11, Lcom/bumptech/glide/load/engine/DecodeHelper;->k:Ljava/lang/Class;
    ...
    iput-object v14, v11, Lcom/bumptech/glide/load/engine/DecodeHelper;->j:Ljava/util/Map;

    move/from16 v14, p11

    iput-boolean v14, v11, Lcom/bumptech/glide/load/engine/DecodeHelper;->q:Z

    move/from16 v14, p12

    iput-boolean v14, v11, Lcom/bumptech/glide/load/engine/DecodeHelper;->r:Z

    iput-object v0, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->h:Lcom/bumptech/glide/GlideContext;

    iput-object v3, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->i:Lcom/bumptech/glide/load/Key;

    iput-object v6, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->j:Lcom/bumptech/glide/Priority;

    iput-object v12, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->k:Lcom/bumptech/glide/load/engine/EngineKey;

    iput v4, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->l:I

    iput v5, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->m:I

    iput-object v7, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->n:Lcom/bumptech/glide/load/engine/DiskCacheStrategy;

    iput-boolean v9, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->t:Z

    iput-object v8, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->o:Lcom/bumptech/glide/load/Options;

    iput-object v13, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->p:Lcom/bumptech/glide/load/engine/DecodeJob$Callback;

    iput v10, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->q:I

    sget-object v0, Lcom/bumptech/glide/load/engine/DecodeJob$RunReason;->a:Lcom/bumptech/glide/load/engine/DecodeJob$RunReason;

    iput-object v0, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->s:Lcom/bumptech/glide/load/engine/DecodeJob$RunReason;

    iput-object v2, v15, Lcom/bumptech/glide/load/engine/DecodeJob;->u:Ljava/lang/Object;

    iget-object v0, v1, Lcom/bumptech/glide/load/engine/Engine;->a:Lcom/bumptech/glide/load/engine/Jobs;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-boolean v2, v13, Lcom/bumptech/glide/load/engine/EngineJob;->p:Z
    ...
    invoke-virtual {v13, v0, v2}, Lcom/bumptech/glide/load/engine/EngineJob;->e(Lcom/bumptech/glide/request/ResourceCallback;Ljava/util/concurrent/Executor;)V

    monitor-enter v13

    :try_start_1
    iput-object v15, v13, Lcom/bumptech/glide/load/engine/EngineJob;->w:Lcom/bumptech/glide/load/engine/DecodeJob;

    sget-object v2, Lcom/bumptech/glide/load/engine/DecodeJob$Stage;->a:Lcom/bumptech/glide/load/engine/DecodeJob$Stage;

    invoke-virtual {v15, v2}, Lcom/bumptech/glide/load/engine/DecodeJob;->o(Lcom/bumptech/glide/load/engine/DecodeJob$Stage;)Lcom/bumptech/glide/load/engine/DecodeJob$Stage;
    ...
    :cond_4
    iget-boolean v2, v13, Lcom/bumptech/glide/load/engine/EngineJob;->n:Z

    if-eqz v2, :cond_5

    iget-object v2, v13, Lcom/bumptech/glide/load/engine/EngineJob;->i:Lcom/bumptech/glide/load/engine/executor/GlideExecutor;

    goto :goto_3

    :cond_5
    iget-boolean v2, v13, Lcom/bumptech/glide/load/engine/EngineJob;->o:Z

    if-eqz v2, :cond_6

    iget-object v2, v13, Lcom/bumptech/glide/load/engine/EngineJob;->j:Lcom/bumptech/glide/load/engine/executor/GlideExecutor;

    goto :goto_3

    :cond_6
    iget-object v2, v13, Lcom/bumptech/glide/load/engine/EngineJob;->h:Lcom/bumptech/glide/load/engine/executor/GlideExecutor;

    goto :goto_3

    :cond_7
    :goto_2
    iget-object v2, v13, Lcom/bumptech/glide/load/engine/EngineJob;->g:Lcom/bumptech/glide/load/engine/executor/GlideExecutor;
    ...
    invoke-direct {v2, v1, v0, v13}, Lcom/bumptech/glide/load/engine/Engine$LoadStatus;-><init>(Lcom/bumptech/glide/load/engine/Engine;Lcom/bumptech/glide/request/ResourceCallback;Lcom/bumptech/glide/load/engine/EngineJob;)V
