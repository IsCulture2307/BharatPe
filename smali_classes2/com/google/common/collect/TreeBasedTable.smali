...
.method public static create()Lcom/google/common/collect/TreeBasedTable;
    ...
    .line 3
    invoke-direct {v0, v1, v1}, Lcom/google/common/collect/TreeBasedTable;-><init>(Ljava/util/Comparator;Ljava/util/Comparator;)V
...
.method public createColumnKeyIterator()Ljava/util/Iterator;
    ...
    invoke-static {v1, v2}, Lcom/google/common/collect/Iterables;->i(Ljava/util/Collection;Lcom/google/common/base/Function;)Ljava/lang/Iterable;

    move-result-object v1

    if-eqz v0, :cond_0

    new-instance v2, Lcom/google/common/collect/Iterators$MergingIterator;

    invoke-direct {v2, v1, v0}, Lcom/google/common/collect/Iterators$MergingIterator;-><init>(Ljava/lang/Iterable;Ljava/util/Comparator;)V

    new-instance v1, Lcom/google/common/collect/TreeBasedTable$1;

    invoke-direct {v1, v2, v0}, Lcom/google/common/collect/TreeBasedTable$1;-><init>(Ljava/util/Iterator;Ljava/util/Comparator;)V
