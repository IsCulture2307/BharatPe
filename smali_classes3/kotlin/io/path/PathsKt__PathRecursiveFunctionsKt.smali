...
.method public static final b(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    :try_start_0
    invoke-static {p2, p0}, Lkotlin/io/path/PathRelativizer;->a(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method public static final c(Lkotlin/jvm/functions/Function3;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/lang/Exception;)Ljava/nio/file/FileVisitResult;
    .locals 0
...
.method public static final d(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    .locals 4
    ...
    invoke-static {p0, v0, p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->e(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    :try_end_1
...
.method public static final e(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    ...
    iget-object v0, p2, Lkotlin/io/path/ExceptionsCollector;->d:Ljava/nio/file/Path;
    ...
    :goto_0
    iput-object v0, p2, Lkotlin/io/path/ExceptionsCollector;->d:Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1, p2}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->d(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V

    iget v2, p2, Lkotlin/io/path/ExceptionsCollector;->b:I
    :try_end_2
    ...
    :cond_2
    :goto_3
    iget-object p0, p2, Lkotlin/io/path/ExceptionsCollector;->d:Ljava/nio/file/Path;
    ...
    :cond_4
    iput-object v1, p2, Lkotlin/io/path/ExceptionsCollector;->d:Ljava/nio/file/Path;
...
.method public static final f(Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    .locals 6
    ...
    iget v0, p1, Lkotlin/io/path/ExceptionsCollector;->b:I
    :try_end_0
    ...
    invoke-static {v4, p1}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->f(Ljava/nio/file/Path;Lkotlin/io/path/ExceptionsCollector;)V
    :try_end_2
    ...
    :cond_1
    :goto_4
    iget v1, p1, Lkotlin/io/path/ExceptionsCollector;->b:I
