...
.method public final T()J
    ...
    invoke-virtual {p0, v7}, Lkotlinx/coroutines/EventLoopImplBase;->Z(Ljava/lang/Runnable;)Z

    move-result v7

    if-eqz v7, :cond_5

    invoke-virtual {v0, v3}, Lkotlinx/coroutines/internal/ThreadSafeHeap;->b(I)Lkotlinx/coroutines/internal/ThreadSafeHeapNode;
    ...
    :cond_15
    iget-wide v3, v4, Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;->a:J
    ...
    invoke-static {v3, v4, v1, v2}, Lkotlin/ranges/RangesKt;->b(JJ)J
...
.method public Y(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/EventLoopImplBase;->Z(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {v0, p1}, Lkotlinx/coroutines/DefaultExecutor;->Y(Ljava/lang/Runnable;)V
...
.method public final d0(JLkotlinx/coroutines/EventLoopImplBase$DelayedTask;)V
    .locals 6
    ...
    :goto_0
    sget-object v3, Lkotlinx/coroutines/EventLoopImplBase;->h:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public final m(JLkotlinx/coroutines/CancellableContinuationImpl;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lkotlinx/coroutines/EventLoopImplBase;->d0(JLkotlinx/coroutines/EventLoopImplBase$DelayedTask;)V
...
.method public shutdown()V
    ...
    invoke-virtual {v4, v5}, Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;->a(Ljava/lang/Object;)I
