...
.field public f:Lorg/reactivestreams/Publisher;
...
.method public constructor <init>(Lorg/reactivestreams/Subscriber;Lio/reactivex/Scheduler$Worker;Lio/reactivex/Flowable;Z)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->a:Lorg/reactivestreams/Subscriber;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->b:Lio/reactivex/Scheduler$Worker;

    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->f:Lorg/reactivestreams/Publisher;
...
.method public final a(JLorg/reactivestreams/Subscription;)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber$Request;-><init>(JLorg/reactivestreams/Subscription;)V

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->b:Lio/reactivex/Scheduler$Worker;
...
.method public final cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->b:Lio/reactivex/Scheduler$Worker;
...
.method public final onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->a:Lorg/reactivestreams/Subscriber;
...
.method public final request(J)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->a(JLorg/reactivestreams/Subscription;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->a(JLorg/reactivestreams/Subscription;)V
...
.method public final run()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->f:Lorg/reactivestreams/Publisher;

    const/4 v1, 0x0

    iput-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->f:Lorg/reactivestreams/Publisher;

    invoke-interface {v0, p0}, Lorg/reactivestreams/Publisher;->b(Lorg/reactivestreams/Subscriber;)V
