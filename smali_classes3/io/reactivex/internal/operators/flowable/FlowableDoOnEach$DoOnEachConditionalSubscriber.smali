...
.method public constructor <init>(Lio/reactivex/internal/fuseable/ConditionalSubscriber;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$DoOnEachConditionalSubscriber;->f:Lio/reactivex/functions/Consumer;

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$DoOnEachConditionalSubscriber;->g:Lio/reactivex/functions/Consumer;

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$DoOnEachConditionalSubscriber;->h:Lio/reactivex/functions/Action;

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$DoOnEachConditionalSubscriber;->i:Lio/reactivex/functions/Action;
...
.method public final G(Ljava/lang/Object;)Z
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$DoOnEachConditionalSubscriber;->f:Lio/reactivex/functions/Consumer;
...
.method public final onComplete()V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$DoOnEachConditionalSubscriber;->h:Lio/reactivex/functions/Action;
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/internal/subscribers/BasicFuseableConditionalSubscriber;->a(Ljava/lang/Throwable;)V
...
.method public final onError(Ljava/lang/Throwable;)V
    ...
    iput-boolean v1, p0, Lio/reactivex/internal/subscribers/BasicFuseableConditionalSubscriber;->d:Z

    :try_start_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$DoOnEachConditionalSubscriber;->g:Lio/reactivex/functions/Consumer;
    ...
    :goto_0
    :try_start_1
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$DoOnEachConditionalSubscriber;->i:Lio/reactivex/functions/Action;
...
.method public final poll()Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v4, p0, Lio/reactivex/internal/subscribers/BasicFuseableConditionalSubscriber;->c:Lio/reactivex/internal/fuseable/QueueSubscription;
    ...
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$DoOnEachConditionalSubscriber;->i:Lio/reactivex/functions/Action;

    if-eqz v4, :cond_1

    :try_start_1
    iget-object v6, p0, Lio/reactivex/internal/operators/flowable/FlowableDoOnEach$DoOnEachConditionalSubscriber;->f:Lio/reactivex/functions/Consumer;
