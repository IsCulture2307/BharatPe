...
# direct methods
.method public constructor <init>(IJJLio/reactivex/observers/SerializedObserver;Lio/reactivex/Scheduler;Ljava/util/concurrent/TimeUnit;Z)V
    .locals 1
    ...
    invoke-direct {p0, p6, v0}, Lio/reactivex/internal/observers/QueueDrainObserver;-><init>(Lio/reactivex/observers/SerializedObserver;Lio/reactivex/internal/queue/MpscLinkedQueue;)V

    new-instance p6, Lio/reactivex/internal/disposables/SequentialDisposable;

    invoke-direct {p6}, Lio/reactivex/internal/disposables/SequentialDisposable;-><init>()V

    iput-object p6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowExactBoundedObserver;->s:Lio/reactivex/internal/disposables/SequentialDisposable;

    iput-wide p2, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowExactBoundedObserver;->g:J

    iput-object p8, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowExactBoundedObserver;->h:Ljava/util/concurrent/TimeUnit;

    iput-object p7, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowExactBoundedObserver;->i:Lio/reactivex/Scheduler;

    iput p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowExactBoundedObserver;->j:I

    iput-wide p4, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowExactBoundedObserver;->l:J

    iput-boolean p9, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowExactBoundedObserver;->k:Z

    if-eqz p9, :cond_0

    invoke-virtual {p7}, Lio/reactivex/Scheduler;->a()Lio/reactivex/Scheduler$Worker;
...
.method public final onComplete()V
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowExactBoundedObserver;->j()V
...
.method public final onSubscribe(Lio/reactivex/disposables/Disposable;)V
    ...
    invoke-virtual/range {v1 .. v7}, Lio/reactivex/Scheduler;->e(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/Disposable;
