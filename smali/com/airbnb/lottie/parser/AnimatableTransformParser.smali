...
.method public static a(Lcom/airbnb/lottie/parser/moshi/JsonReader;Lcom/airbnb/lottie/LottieComposition;)Lcom/airbnb/lottie/model/animatable/AnimatableTransform;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/airbnb/lottie/model/animatable/AnimatableFloatValue;->n()Ljava/util/List;
    ...
    invoke-virtual {v12}, Lcom/airbnb/lottie/model/animatable/AnimatablePathValue;->l()Z

    move-result v0

    if-eqz v0, :cond_9

    iget-object v0, v12, Lcom/airbnb/lottie/model/animatable/AnimatablePathValue;->a:Ljava/util/List;
    ...
    invoke-interface {v13}, Lcom/airbnb/lottie/model/animatable/AnimatableValue;->l()Z

    move-result v0

    if-eqz v0, :cond_a

    invoke-interface {v13}, Lcom/airbnb/lottie/model/animatable/AnimatableValue;->n()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lcom/airbnb/lottie/model/animatable/AnimatableFloatValue;->l()Z

    move-result v0

    if-eqz v0, :cond_c

    invoke-virtual {v1}, Lcom/airbnb/lottie/model/animatable/AnimatableFloatValue;->n()Ljava/util/List;
    ...
    invoke-virtual {v14}, Lcom/airbnb/lottie/model/animatable/AnimatableScaleValue;->l()Z

    move-result v0

    if-eqz v0, :cond_f

    invoke-virtual {v14}, Lcom/airbnb/lottie/model/animatable/AnimatableScaleValue;->n()Ljava/util/List;
    ...
    invoke-virtual {v15}, Lcom/airbnb/lottie/model/animatable/AnimatableFloatValue;->l()Z

    move-result v0

    if-eqz v0, :cond_10

    invoke-virtual {v15}, Lcom/airbnb/lottie/model/animatable/AnimatableFloatValue;->n()Ljava/util/List;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/airbnb/lottie/model/animatable/AnimatableFloatValue;->l()Z

    move-result v0

    if-eqz v0, :cond_12

    invoke-virtual/range {v16 .. v16}, Lcom/airbnb/lottie/model/animatable/AnimatableFloatValue;->n()Ljava/util/List;
