...
.method public constructor <init>(Landroid/text/PrecomputedText$Params;)V
    ...
    .line 8
    invoke-static {p1}, Landroid/support/v4/media/session/a;->n(Landroid/text/PrecomputedText$Params;)Landroid/text/TextPaint;
    ...
    .line 9
    invoke-static {p1}, Landroid/support/v4/media/session/a;->m(Landroid/text/PrecomputedText$Params;)Landroid/text/TextDirectionHeuristic;
    ...
    .line 10
    invoke-static {p1}, Landroid/support/v4/media/session/a;->a(Landroid/text/PrecomputedText$Params;)I
...
.method public constructor <init>(Landroid/text/TextPaint;Landroid/text/TextDirectionHeuristic;II)V
    ...
    .line 2
    invoke-static {p1}, Landroid/support/v4/media/session/a;->j(Landroid/text/TextPaint;)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    .line 3
    invoke-static {v0, p3}, Landroid/support/v4/media/session/a;->h(Landroid/text/PrecomputedText$Params$Builder;I)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    .line 4
    invoke-static {v0, p4}, Landroid/support/v4/media/session/a;->B(Landroid/text/PrecomputedText$Params$Builder;I)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    .line 5
    invoke-static {v0, p2}, Landroid/support/v4/media/session/a;->i(Landroid/text/PrecomputedText$Params$Builder;Landroid/text/TextDirectionHeuristic;)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    .line 6
    invoke-static {v0}, Landroid/support/v4/media/session/a;->k(Landroid/text/PrecomputedText$Params$Builder;)Landroid/text/PrecomputedText$Params;
...
.method public final a(Landroidx/core/text/PrecomputedTextCompat$Params;)Z
    ...
    iget-object v3, p1, Landroidx/core/text/PrecomputedTextCompat$Params;->a:Landroid/text/TextPaint;
