...
.method public final declared-synchronized e(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    invoke-interface {v3, p0, p1, p2}, Landroidx/appcompat/widget/ResourceManagerInternal$ResourceManagerHooks;->d(Landroidx/appcompat/widget/ResourceManagerInternal;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public final declared-synchronized g(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/ResourceManagerInternal$ResourceManagerHooks;->a(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
...
.method public final h(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, p1}, Landroidx/appcompat/widget/ResourceManagerInternal;->g(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p4, v0}, Landroidx/core/graphics/drawable/DrawableCompat;->j(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    :cond_0
    invoke-interface {p1, p2}, Landroidx/appcompat/widget/ResourceManagerInternal$ResourceManagerHooks;->c(I)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p4, v1}, Landroidx/core/graphics/drawable/DrawableCompat;->k(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
