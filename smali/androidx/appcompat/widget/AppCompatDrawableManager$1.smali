...
.method public static g(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, p1}, Landroidx/appcompat/widget/ThemeUtils;->c(ILandroid/content/Context;)I
    ...
    invoke-static {v1, p0}, Landroidx/core/graphics/ColorUtils;->c(II)I
...
# virtual methods
.method public final a(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
    .locals 7
    ...
    sget p1, Landroidx/appcompat/R$color;->abc_tint_edittext:I

    invoke-static {p1, p2}, Landroidx/appcompat/content/res/AppCompatResources;->a(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget p1, Landroidx/appcompat/R$color;->abc_tint_switch_track:I
    ...
    invoke-static {v1, p2}, Landroidx/appcompat/widget/ThemeUtils;->c(ILandroid/content/Context;)I
    ...
    sget p1, Landroidx/appcompat/R$attr;->colorButtonNormal:I

    invoke-static {p1, p2}, Landroidx/appcompat/widget/ThemeUtils;->c(ILandroid/content/Context;)I

    move-result p1

    invoke-static {p1, p2}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->g(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, p2}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->g(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget p1, Landroidx/appcompat/R$attr;->colorAccent:I
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/AppCompatDrawableManager$1;->f(I[I)Z
    ...
    sget p1, Landroidx/appcompat/R$color;->abc_tint_default:I
    ...
    sget p1, Landroidx/appcompat/R$color;->abc_tint_btn_checkable:I
    ...
    sget p1, Landroidx/appcompat/R$color;->abc_tint_seek_thumb:I
    ...
    :cond_c
    :goto_1
    sget p1, Landroidx/appcompat/R$color;->abc_tint_spinner:I
...
.method public final b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p2, p1}, Landroidx/appcompat/widget/ThemeUtils;->c(ILandroid/content/Context;)I

    move-result p1

    invoke-static {p1, v1}, Landroidx/appcompat/widget/AppCompatDrawableManager;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public final c(I)Landroid/graphics/PorterDuff$Mode;
    .locals 1
...
.method public final d(Landroidx/appcompat/widget/ResourceManagerInternal;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 3
...
.method public final e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p3, p1}, Landroidx/appcompat/widget/ThemeUtils;->c(ILandroid/content/Context;)I
    ...
    invoke-static {v0, p1}, Landroidx/appcompat/widget/ThemeUtils;->b(ILandroid/content/Context;)I
