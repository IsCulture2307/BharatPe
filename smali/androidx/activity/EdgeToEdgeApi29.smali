...
.method public a(Landroidx/activity/SystemBarStyle;Landroidx/activity/SystemBarStyle;Landroid/view/Window;Landroid/view/View;ZZ)V
    ...
    iget p2, p2, Landroidx/activity/SystemBarStyle;->b:I

    goto :goto_1

    :cond_3
    iget p2, p2, Landroidx/activity/SystemBarStyle;->a:I

    :goto_1
    invoke-virtual {p3, p2}, Landroid/view/Window;->setNavigationBarColor(I)V

    invoke-static {p3}, Landroidx/activity/j;->g(Landroid/view/Window;)V
    ...
    :cond_4
    invoke-static {p3, v0}, Landroidx/activity/j;->h(Landroid/view/Window;Z)V
    ...
    invoke-virtual {p1, p3}, Landroidx/core/view/WindowInsetsControllerCompat;->c(Z)V

    xor-int/2addr p2, p6

    invoke-virtual {p1, p2}, Landroidx/core/view/WindowInsetsControllerCompat;->b(Z)V
