...
.method public final b(Landroid/view/KeyEvent;)V
    ...
    iget-object v0, v0, Landroidx/compose/ui/text/input/TextInputServiceAndroid;->j:Lkotlin/Lazy;
...
.method public final c(ZZZZZZ)V
    ...
    iget-object v0, v0, Landroidx/compose/ui/text/input/TextInputServiceAndroid;->l:Landroidx/compose/ui/text/input/CursorAnchorInfoController;
    ...
    :try_start_0
    iput-boolean p3, v0, Landroidx/compose/ui/text/input/CursorAnchorInfoController;->f:Z

    iput-boolean p4, v0, Landroidx/compose/ui/text/input/CursorAnchorInfoController;->g:Z

    iput-boolean p5, v0, Landroidx/compose/ui/text/input/CursorAnchorInfoController;->h:Z

    iput-boolean p6, v0, Landroidx/compose/ui/text/input/CursorAnchorInfoController;->i:Z

    if-eqz p1, :cond_0

    const/4 p1, 0x1

    iput-boolean p1, v0, Landroidx/compose/ui/text/input/CursorAnchorInfoController;->e:Z

    iget-object p1, v0, Landroidx/compose/ui/text/input/CursorAnchorInfoController;->j:Landroidx/compose/ui/text/input/TextFieldValue;
    ...
    :cond_0
    :goto_0
    iput-boolean p2, v0, Landroidx/compose/ui/text/input/CursorAnchorInfoController;->d:Z
    :try_end_0
...
.method public final d(Ljava/util/ArrayList;)V
    ...
    iget-object v0, v0, Landroidx/compose/ui/text/input/TextInputServiceAndroid;->e:Lkotlin/jvm/functions/Function1;
...
.method public final e(Landroidx/compose/ui/text/input/RecordingInputConnection;)V
    .locals 4

    iget-object v0, p0, Landroidx/compose/ui/text/input/TextInputServiceAndroid$createInputConnection$1;->a:Landroidx/compose/ui/text/input/TextInputServiceAndroid;

    iget-object v1, v0, Landroidx/compose/ui/text/input/TextInputServiceAndroid;->i:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Landroidx/compose/ui/text/input/TextInputServiceAndroid;->i:Ljava/util/ArrayList;
